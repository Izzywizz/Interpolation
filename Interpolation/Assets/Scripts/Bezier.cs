...
public class Bezier : MonoBehaviour
{
    ...
    //SEt checkToStart to true to start moving
    ...
    private void Update()
    {
        ...
        if (moving)
        {
            u = (Time.time - timeStart) / timeDuration; //Total time over a given period ensuring that the movemtn completes over a given period
